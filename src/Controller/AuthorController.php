...
class AuthorController extends AbstractController
{
    ...
    public function Affiche (AuthorRepository $repository) // pour afficher le tableau comme dans l'ennonce et pour le template ou elle vas etre affihcer et dans affiche html.twig//
        {
